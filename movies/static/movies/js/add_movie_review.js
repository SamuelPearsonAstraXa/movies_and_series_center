...
const add_movie_review_form = document.getElementById('add_movie_review_form');
const text = document.getElementById('id_text');

loader.style.display = 'none';
text.setAttribute('placeholder', 'Review text here...')

add_movie_review_form.addEventListener('submit', e=>{
    e.preventDefault();
    loader.style.display = 'block';
    
    fetch(add_movie_review_form.action, {
        method: 'POST',
        body: new FormData(add_movie_review_form),
        headers: {
