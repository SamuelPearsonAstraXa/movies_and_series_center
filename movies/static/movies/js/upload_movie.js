const upload_movie_form = document.getElementById('upload-movie-form');
...
upload_movie_form.addEventListener('submit', e=>{
    e.preventDefault();
    loader.style.display = 'flex';
    
    fetch(upload_movie_form.action, {
        method: 'POST',
        body: new FormData(upload_movie_form),
        headers: {
